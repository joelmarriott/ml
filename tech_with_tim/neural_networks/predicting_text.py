...
# model down here - uncomment this block to generate the model
'''
...
with open(os.path.join(os.path.realpath(os.path.dirname(__file__)),
    ...
    for line in f.readlines():
        ...
        encode = tf.keras.preprocessing.sequence.pad_sequences([encode], value=word_index['<PAD>'], padding='post', maxlen=250)
